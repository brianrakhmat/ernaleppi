<?php
	...
	$query1=mysql_query("INSERT INTO datalaptop ( nama_laptop, jenis_laptop,tipe_laptop,harga_rupiah,harga,harga_B,layar_inch,layar,layar_B,penyimpanan_GB,penyimpanan,
	penyimpanan_B,ram_GB,ram,ram_B,jenis_processor,processor,processor_B,grafis_jenis,grafis,grafis_B) 
	VALUE 
	( '$nama_laptop' , '$jenis_laptop','$tipe_laptop','$harga_rupiah','$harga','$harga_B', '$layar_inch','$layar', '$layar_B','$penyimpanan_GB','$penyimpanan',
	'$penyimpanan_B','$ram_GB','$ram','$ram_B','$jenis_processor','$processor','$processor_B','$grafis_jenis','$grafis','$grafis_B')");
	if ($query1) {
